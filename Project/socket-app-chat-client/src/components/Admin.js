...
export default function Admin() {
  const img =
    "https://mdbootstrap.com/img/Photos/new-templates/tables/img4.jpg";
  ...
  return (
    <div>
      ...
      <h1 style={{ textAlign: "center", color: "yellow" }}>Admin Page</h1>

      <div className="ml-5 mb-2"  style={{width:400}}>
        <div class="input-group">
          ...
          <div class="input-group-prepend">
            ...
            <div>
                <button className="btn btn-primary ml-3" onClick={handleCreate}>Create New User</button>
              </div>
          </div>
        </div>
      </div>
      ...
      <section class="intro">
        <div class="bg-image h-100" style={{ backgroundImage: `url (${img})` }}>
